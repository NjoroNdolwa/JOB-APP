...
public class JobClass {
    ...
    public void setSelect_due_date(String select_due_date) {this.select_due_date = select_due_date;}
    ...
    public JobClass(String job_tittle, String job_location, String job_salary, String job_vacancies,String select_due_date){
        this.job_tittle = job_tittle;
        this.job_location = job_location;
        this.job_salary = job_salary;
        this.job_vacancies = job_vacancies;
